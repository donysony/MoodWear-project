...
public class User {
	...
	public int getMember_reserves() {
		return member_reserves;
	}
	public void setMember_reserves(int member_reserves) {
		this.member_reserves = member_reserves;
	}
