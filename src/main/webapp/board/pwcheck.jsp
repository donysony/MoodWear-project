        ...
        <article class="inquiry_article">
            <div class="tablediv">
                ...
                <table class="inquirytable">
                    ...
                    <tr >
                        <td id="password">비밀번호 &emsp;<input type="password" id="pw" name="pw" onkeypress="if(event.keyCode ==13){checkPw('<%=board_pw %>')};"> &emsp;<button type="button" id="check" onClick="javascript:checkPw('<%=board_pw %>');" >확인</button></td>
                    </tr>
                </table>
            <div class="buttondiv">    
