...
<title>리뷰 작성</title>
    ...
    <script>
      ...
      function checkImg(obj){
        ...
        function deleteimg(){
              document.getElementById("aimg").src="img/plus.png";
              a1 = 0;
        }
        function deleteimg2(){
              document.getElementById("bimg").src="img/plus.png";
              a2 = 0;
        }
        function deleteimg3(){
              document.getElementById("cimg").src="img/plus.png";
              a3 = 0;
        }
    </script>
</head>
      ...
      <form action="">
        ...
        <div class="contents">
         ...
         <section id="mom">
            <article>
              <div class="wrap">
                <img class="image" src="img/plus.png" id="aimg">
                <img class="image" src="img/plus.png" id="bimg">
                <img class="image" src="img/plus.png" id="cimg">
              </div>
            </article>
